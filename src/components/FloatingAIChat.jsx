...
const KB = [
  ...
  { keys: ["project", "built", "developed", "app", "application", "portfolio", "school", "gst", "trade", "tracker", "income"], ans: "7 projects total:\n• MDA Royal Technologies — Corporate website\n• KSRCT Venue Booking — Firebase real-time booking\n• Leave Management System — PHP + MySQL\n• Skin Disease Detection — TensorFlow CNN + Flutter AI app\n• School Management System — Student records, attendance & admin dashboard\n• Trade Mentor GST — GST learning & trade compliance platform\n• Royal Computers Tracker — Personal daily income tracking tool for his own office" },
        ...
        <div className="ai-panel animate-scaleUp"
          ...
          <div style={{ padding: "12px 16px", borderBottom: "1px solid var(--border)", background: "var(--bg3)", display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <p style={{ fontFamily: "JetBrains Mono,monospace", fontSize: "0.56rem", color: "#4ADE80", marginTop: "3px", letterSpacing: "0.06em" }}>● ONLINE · Always ready</p>
            </div>
          ...
          {/* Messages */}
          <div style={{ flex: 1, overflowY: "auto", padding: "14px", display: "flex", flexDirection: "column", gap: "10px", maxHeight: "340px" }}>
            {msgs.map((m, i) => (
          ...
          <div style={{ padding: "10px 12px", borderTop: "1px solid var(--border)", display: "flex", gap: "8px" }}>
            <input ref={inpRef} value={input} onChange={e => setInput(e.target.value)}
              ...
              style={{ flex: 1, padding: "9px 12px", borderRadius: "8px", fontSize: "0.8rem", background: "var(--bg3)", border: "1px solid var(--border)", color: "var(--text)", outline: "none", fontFamily: "Plus Jakarta Sans,sans-serif", transition: "border-color .2s" }}
